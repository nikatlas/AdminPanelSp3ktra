  ...
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header" >
        ...
        <div class="menu">
        	        	...
        	        	<a href="/ebay/list/alerts" <?php if(strpos($_SERVER['REQUEST_URI'],"/ebay/list/alerts")!==false)echo 'class="selected"';?> ><div>Alerts<span class="badge pull-right" style="position:relative;top:17px;"><?php echo $m->getAlertsNum('','','','','');?></span></div></a>
